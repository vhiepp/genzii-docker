...
export default function Message() {
    ...
    const fetchDataUser = async () => {
        ...
        await axios.get(`${process.env.REACT_APP_DOMAIN_BACKEND}/auth/profile`, { withCredentials: true })
            .then(responses => {
    ...
    const callBack = async (querySnapshot) => {
        ...
        if (id_arr.length > 0) {
            const resProfile = await axios.post(`${process.env.REACT_APP_DOMAIN_BACKEND}/user/profile`, {
                uid: id_arr,
                group: true
